...
let me = {
  ...
  state : 'AZ',
  age : 30 , 
  greeter : function(){console.log('Hello! My name is ' + me.name + ' and I live in ' + me.state)}
}
//////////////////PROBLEM 12////////////////////
/* 
...
function isItBob(object, cb){
  object.name === 'Bob' ? cb(true) : cb(false)
}
//////////////////PROBLEM 17////////////////////
/*
